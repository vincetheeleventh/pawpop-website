...
export const PurchaseModalEqualTiers = ({ isOpen, onClose, artwork }: PurchaseModalEqualTiersProps) => {
  ...
  const tiers = [
    ...
    },
    {
      ...
      description: 'Professional print on fine art paper (285 g/m²)',
      price: getProductPricing(ProductType.ART_PRINT, '16x24', 'US'),
      features: ['Museum-quality fine art paper', 'Ready to frame', 'Archival inks'],
      delivery: '3-5 days',
      badge: 'Best Value'
    },
    {
      ...
      price: getProductPricing(ProductType.CANVAS_FRAMED, '16x24', 'US'),
